...
function App() {
  //TODO: STEP 2 - Establish your applictaion's 
  // state with some useState hooks.  You'll need one for 
  // the home score and another for the away score.
  // const TigerHandler = function (increase){
  //   setTscore(Tscore + increase)
  // };
      ...
      <section className="scoreboard">
        <div className="topRow">
          <div className="home">
            ...
            {/* TODO STEP 3 - We need to change the
             hardcoded values in these divs to accept 
